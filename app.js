        ...
        async function loadLogos() {
            // Crear FileReader para convertir archivos a data URLs
            const ivSignImg = document.getElementById('ivSignLogo');
            const ivNeosImg = document.getElementById('ivNeosLogo');
            
            // Por ahora usamos placeholders sólidos, luego los reemplazaremos con las imágenes reales
            // Estos se cargarán cuando el archivo se despliegue
